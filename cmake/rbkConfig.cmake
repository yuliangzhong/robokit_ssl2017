# project version
# ---------------
set(ROBOKIT_VERSION_MAJOR "1")
set(ROBOKIT_VERSION_MINOR "1")
set(ROBOKIT_VERSION_PATCH "0")
set(ROBOKIT_VERSION ${ROBOKIT_VERSION_MAJOR}.${ROBOKIT_VERSION_MINOR}.${ROBOKIT_VERSION_PATCH})
mark_as_advanced(ROBOKIT_VERSION)

message("RoboKit v${ROBOKIT_VERSION}, © 2015-2017 Seer Robotics Co,.Ltd.")
...
IF((NOT IS_SUBPROJECT) AND (NOT RBK_PLUGIN))
    set(PROTO_DIR "${RBK_OUTPUT_DIR}/proto")
ELSE()
...
ELSEIF(WIN32)
    ...
    ELSE(CMAKE_CL_64)
        ...
        ELSEIF(MSVC10)
            # Visual Studio 2010
            set(RBK_LIBLUA_GIT_NAME "lua-5.1.5_Win32_msvc10" CACHE STRING "lua git repo name")
            set(RBK_LIBPROTOBUF_GIT_NAME "protobuf-3.2.0_Win32_msvc10" CACHE STRING "protobuf git repo name")
            set(RBK_LIBBFL_GIT_NAME "orocos_bfl-lib-windows-x86-vs2010" CACHE STRING "bfl git repo name")
            set(RBK_LIBURG_GIT_NAME "urg-1.2.0_Win32_msvc10" CACHE STRING "urg git repo name")
            set(RBK_LIBARIA_GIT_NAME "Aria-lib-windows-x86-vs2010" CACHE STRING "aria git repo name")
            set(RBK_LIBSQLITE3_GIT_NAME "sqlite-3.17.0_Win32" CACHE STRING "sqlite3 git repo name")
