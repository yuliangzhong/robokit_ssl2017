-- by Soap 2015-04-14
-- YYS 2015-06-10
local PENALTY_THRESHOLD_DIST = 0.3 * param.pitchLength
local MIDDLE_THRESHOLD_Y = 0.125 * param.pitchWidth
...
local OTHER_SIDE_POS = function()
  ...
  local X_POS = INTER_POS():x()+150
  if X_POS > 280 then
    X_POS = 280
  end
  return CGeoPoint:new_local(X_POS, factor * param.pitchWidth * 0.2)
