...
["sidepass"] = {
	...
	Assister = USE_CHIP and task.chipPass(CHIP_POS, 230) or task.goAndTurnKick(CHIP_POS, 560),
	Leader   = task.goCmuRush(SYNT_CORNER_POS1),
	Special  = task.goCmuRush(SYNT_CORNER_POS2),
	Middle   = task.goCmuRush(ANTI_CORNER_POS1),
	Defender = task.singleBack(),
...
["sidekick"] = {
	...
	Middle   = USE_CHIP and task.waitTouch(ANTI_CORNER_POS1, 0) or task.InterNew(),
	Defender = task.leftBack(),
	Assister = task.rightBack(),
	Goalie   = task.goalie(),
	match    = "{MLS}(AD)"
