    ...
    namespace core {
        ...
        public:
            ...
            R call() {
                ...
                LogInfo("callDelegate: " << _delegate_name << " @ " << _device_name << " # ()");
            ...
            void call(const P0& p0) {
                ...
                LogInfo("callDelegate: " << _delegate_name << " @ " << _device_name << " # (" << p0 << ")");
            ...
            void call(const P0& p0, const P1& p1) {
                ...
                LogInfo("callDelegate: " << _delegate_name << " @ " << _device_name << " # (" << p0 << ", " << p1 << ")");
            ...
            void call(const P0& p0, const P1& p1, const P2& p2) {
                ...
                LogInfo("callDelegate: " << _delegate_name << " @ " << _device_name << " # (" << p0 << ", " << p1 << ", " << p2 << ")");
            ...
            void call(const P0& p0, const P1& p1, const P2& p2, const P3& p3) {
                ...
                LogInfo("callDelegate: " << _delegate_name << " @ " << _device_name << " # (" << p0 << ", " << p1 << ", " << p2 << ", " << p3 << ")");
            ...
            R doDelegateFunc(const std::string& func_name) {
                ...
                if (ret == 0) {
                    ...
                    LogFatal("Run delegate function error: " << lua_tostring(_lua_state, lua_gettop(_lua_state)));
