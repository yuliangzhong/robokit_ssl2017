...
namespace rbk {
    namespace lua {
        ...
        RBK_DLL_EXPORT void reverseLuaState(lua_State *L);
        ...
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const double& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<double>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<double>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const float& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<float>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<float>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const int& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<int>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<int>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const unsigned int& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<unsigned int>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<unsigned int>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const int16_t& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<int16_t>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<int16_t>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const uint16_t& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<uint16_t>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<uint16_t>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const int64_t& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<int64_t>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<int64_t>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const uint64_t& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<uint64_t>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<uint64_t>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const char& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<char>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<char>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const unsigned char& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<unsigned char>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<unsigned char>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const bool& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<bool>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<bool>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::string& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const std::vector<std::string>& t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::Nil<std::string>& nil_t);
        template<> RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const rbk::lua::nilType& nil);

        RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, const char* t);
        RBK_DLL_EXPORT void pushLuaStackTraits(lua_State* L, char* t);
        ...
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, double& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<double>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<double>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, float& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<float>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<float>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, int& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<int>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<int>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, unsigned int& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<unsigned int>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned int>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, int16_t& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<int16_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<int16_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, uint16_t& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<uint16_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<uint16_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, int64_t& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<int64_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<int64_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, uint64_t& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<uint64_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<uint64_t>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, char& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<char>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<char>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, unsigned char& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<unsigned char>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned char>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, bool& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<bool>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<bool>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::string& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, std::vector<std::string>& t);
        template<> RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, rbk::lua::Nil<std::string>& t);
        RBK_DLL_EXPORT void popLuaStackTraits(lua_State* L, char* t);
        ...
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, double& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<double>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<double>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, float& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<float>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<float>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, int& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<int>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<int>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, unsigned int& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<unsigned int>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned int>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, int16_t& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<int16_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<int16_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, uint16_t& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<uint16_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<uint16_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, int64_t& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<int64_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<int64_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, uint64_t& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<uint64_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<uint64_t>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, char& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<char>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<char>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, unsigned char& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<unsigned char>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned char>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, bool& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<bool>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<bool>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::string& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, std::vector<std::string>& t, const int& index);
        template<> RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, rbk::lua::Nil<std::string>& t, const int& index);
        RBK_DLL_EXPORT void getLuaStackTraits(lua_State* L, char* t, const int& index);
        ...
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, double& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<double>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<double>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, float& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<float>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<float>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, int& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<int>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<int>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, unsigned int& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<unsigned int>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned int>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, int16_t& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<int16_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<int16_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, uint16_t& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<uint16_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<uint16_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, int64_t& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<int64_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<int64_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, uint64_t& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<uint64_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<uint64_t>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, char& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<char>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<char>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, unsigned char& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<unsigned char>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<unsigned char>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, bool& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<bool>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<bool>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::string& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, std::vector<std::string>& t);
        template<> RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, rbk::lua::Nil<std::string>& t);
        RBK_DLL_EXPORT void popFirstLuaStackTraits(lua_State* L, char* t);

        //-------------------------executeLuaFunc---------------------------//

        RBK_DLL_EXPORT void executeLuaFunc(lua_State* L, const char* func_name);
