...
#include <robokit/core/error_code_define.h>
...
namespace rbk {
    ...
    public:
        ...
        boost::chrono::time_point<boost::chrono::system_clock> getTimePoint() const {
            return _timePoint;
        }
        ...
        virtual bool assign(uint16_t code) {
            _code = code;
            return true;
        }
    ...
    protected:
        ...
        uint16_t _code;
        uint64_t _count;
        boost::chrono::time_point<boost::chrono::system_clock> _timePoint;
        friend ErrorCodes;
    private:
        Code& operator++();
