...
namespace rbk {
    namespace core {
        ...
        class RBK_DLL_EXPORT BaseService {
        public:
        ...
        int callMemFunc(Cla& cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # ()");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ", " << p6 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ", " << p6 << ", " << p7 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ", " << p6 << ", " << p7 << ", " << p8 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ", " << p6 << ", " << p7 << ", " << p8 << ", " << p9 << ")");
        ...
        int callMemFunc(Cla &cla, Func func, lua_State *L, int index, const std::string& serviceName) {
            ...
            LogInfo("serviceCall: " << serviceName << " @ " << cla.name() << " # (" << p1 << ", " << p2 << ", " << p3 << ", " << p4 << ", " << p5 << ", " << p6 << ", " << p7 << ", " << p8 << ", " << p9 << ", " << p10 << ")");
