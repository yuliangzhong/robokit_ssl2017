	...
	namespace algorithm
	{
		...
		public:
			...
			void GenerateCurrentVelocity(rbk::foundation::PoseSE2 initial_state,
				...
				double &vx, double &vy, double &vw, bool is_real_final, bool use_exter_stable = false, double stable_angle = 9999);
		...
		private:
			...
			double			m_target_dir;
			double			m_cur_dist;
            rbk::foundation::GeoPoint    m_cur_pos;
			rbk::foundation::PoseSE2	m_last_terminal;
            rbk::foundation::PoseSE2    m_terminal;
