...
namespace rbk{
	namespace algorithm{
		...
		public:
			...
			// PosStart_ .. ConPoint0_ .. ConPoint1_ .. PosEnd_
			// 构造时注意4个点的顺序
			Chamferangle(rbk::foundation::GeoPoint p0, rbk::foundation::GeoPoint p1, rbk::foundation::GeoPoint p2, double r);
			
			bool IsValid();
			void SetStartPoint(const rbk::foundation::GeoPoint &);
			void SetEndPoint(const rbk::foundation::GeoPoint &);
			void SetMidPoint0(const rbk::foundation::GeoPoint &);
		...
		public:
			// 根据4个点计算轨迹
			static const int frac_ = 50;
			void cal(int num = 50);
			//void cal_curvature();
			rbk::foundation::GeoPoint PosStart_;
			rbk::foundation::GeoPoint PosEnd_;
			rbk::foundation::GeoPoint PosMid_;
			double R_;
