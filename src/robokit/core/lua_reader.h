...
namespace rbk {
    namespace lua {
        ...
        class RBK_DLL_EXPORT LuaReader {
        public:
            LuaReader();
            ~LuaReader();
            ...
            void runLuaFunc(TIN1 in1, const char* func_name) {
        ...
        template<>
        RBK_DLL_EXPORT bool LuaReader::LoadFromLua<std::string>(const char* str, std::string& res);

        template<>
        RBK_DLL_EXPORT bool LuaReader::LoadFromLua<int>(const char* str, int& res);

        template<>
        RBK_DLL_EXPORT bool LuaReader::LoadFromLua<double>(const char* str, double& res);

        template<>
        RBK_DLL_EXPORT bool LuaReader::LoadFromLua<bool>(const char* str, bool& res);
    } // namespace lua
} // namespace rbk
