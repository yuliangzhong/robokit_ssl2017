    ...
    namespace core {
        ...
        public:
            ...
            R fire() {
                ...
                LogInfo("fireEvent: " << m_event_name << " @ " << m_device_name << " # ()");
            ...
            void fire(const P0& p0) {
                ...
                LogInfo("fireEvent: " << m_event_name << " @ " << m_device_name << " # (" << p0 << ")");
                std::string bind_func = m_bind_func;
            ...
            void fire(const P0& p0, const  P1& p1) {
                ...
                LogInfo("fireEvent: " << m_event_name << " @ " << m_device_name << " # (" << p0 << ", " << p1 << ")");
                std::string bind_func = m_bind_func;
            ...
            void fire(const P0& p0, const P1& p1, const P2& p2) {
                ...
                LogInfo("fireEvent: " << m_event_name << " @ " << m_device_name << " # (" << p0 << ", " << p1 << ", " << p2 << ")");
                std::string bind_func = m_bind_func;
            ...
            void fire(const P0& p0, const P1& p1, const P2& p2, const P3& p3) {
                ...
                LogInfo("fireEvent: " << m_event_name << " @ " << m_device_name << " # (" << p0 << ", " << p1 << ", " << p2 << ", " << p3 << ")");
                std::string bind_func = m_bind_func;
            ...
            void doEventFunc(const std::string& func_name) {
                ...
                if (ret != 0) {
                    LogFatal("Run event function error: " << lua_tostring(m_lua_state, lua_gettop(m_lua_state)));
