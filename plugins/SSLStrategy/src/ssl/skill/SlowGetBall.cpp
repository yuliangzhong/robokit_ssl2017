...
void CSlowGetBall::plan(const CVisionModule* pVision)
{
	...
	if (Verbose)
	{
		...
		cout<<fraredOn<<"   ballCatched: "<<ballCatched<<"   catchBallCount : "<<catchBallCount<<"   trueCatchBall: "<<trueBallCatched<<endl<<endl;
	}
